...
class APIClient:
    ...
    def __init__(self, http_debug_level=0):
        self.port = 443                              # port on management server
        self.fingerprint = None                      # management server fingerprint
    ...
    # api_query
    # ----------------------------------------------------
    # The APIs that return a list of objects are limitted by the number of objects that they return.
    ...
    #
    # arguments:
    #    command        - name of API command. This command should be an API that returns an array of objects (for example: show-hosts, show netowrks, ...)
    ...
    def api_query(self, command, details_level="standard"):
        ...
        all_objects = []     # accumulate all teh objects from all the API calls
        ...
        while not finished:
            ...
            api_res = self.api_call(command, {"limit": limit, "offset": iterations*limit, "details-level": details_level})
            ...
            if api_res.success is True:
                ...
                return api_res
        api_res.data = all_objects; # replace the data from the last API call with the array of all objects.
        return api_res
    ...
    def check_fingerprint(self,server):
        ...
        if fingerprint == "":
            ...
            if self.ask_yes_no_question("Do you accept this fingerprint?"):
                if self.save_fingerprint_to_file(server, fingerprint): # Save it.
        ...
        self.fingerprint = fingerprint  # set the actual fingerprint in the class instance
        return True
